...
import ImageSlider from "./bmwslider";
import { Bmwslider } from "./SliderData";
...
<Link to="/backend" style={{top:"40px",left:"1100px"}}>LOGIN</Link>
      ...
      <ImageSlider slides={Bmwslider}/>
        <div className="na">BMW 3 SERIES 320D</div>
        <div className="lk">
  ...
  <p>
    ...
    2
        ...
        <div className="des">
          ...
          <br></br>
          <br></br>
          • Prectision cut Alloy
          <br></br>
          <br></br>
          • Irfan's View preowned car
          <br></br>
          <br></br>
