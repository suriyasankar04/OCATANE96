...
<div class="wrappe">
  <img src={require("D:/react/myproject/src/octane96/yc.png")} style={{position: "absolute",width: "590px",height: "500px",left: "455px",top: "1700px"}}alt="yc"/>
    ...
    <div id="id01" class="modal">
      <form class="modal-content animate">
        <div class="container">
          ...
          <input type="text" placeholder="Engine Number" name="i9" required/>
          <button onClick={shooot}  className='bt'>SELL</button>
        </div>
      </form>
    ...
    <div>
    <div class="contho"></div>
    <div class="coho"></div>
    <div class="cnho">Contact us</div>
    <div className='cn1ho'>Visit octane96 and we would commit to giving you best in class service with personalised attention and assistance to your requirements or contact us and we will make the delivery of your car a memorable one.</div>
    <div className='cn2ho'>
    ...
    <div className='cho'>Follow us</div>
    <div className='cn8ho'>
