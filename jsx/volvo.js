...
import ImageSliderj from "./volvoimage";
...
<Link to="/backend" style={{top:"40px",left:"1100px"}}>LOGIN</Link>
      ...
      <ImageSliderj slides={Volvoslider}/>
        <div className="na">VOLVO XC60 D5 Inscription</div>
        <div className="lk">
 ...
 <div className="ans">
  <p>
    ...
    1
        ...
        <div className="kj">
         Fully Serviced in Volvo On November2022
        </div>
        <div className="des">
          <h3>Description</h3>
          <br></br>                        
