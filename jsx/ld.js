...
import {Ldslider} from "./ldslider";
import ImageSliderj from "./ldimage";

export default function BMW3(){
    return(
  <div>
...
<Link to="/backend" style={{top:"40px",left:"1100px"}}>LOGIN</Link>
      ...
      <ImageSliderj slides={Ldslider}/>
        <div className="na">BMW 320 LD</div>
        <div className="lk">
